...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case ensurancev1alpha1.SchemeGroupVersion.WithResource("prioritylevels"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Ensurance().V1alpha1().PriorityLevels().Informer()}, nil
